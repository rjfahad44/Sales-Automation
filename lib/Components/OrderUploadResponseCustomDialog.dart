      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("ChemistId : ${widget.response.data.chemistId}",
              style: const TextStyle(
                color: Colors.black,
                fontSize: 18.0,
                fontWeight: FontWeight.w600,
            ...
            Text("Total Products : ${widget.response.data.orderDetails.length}",
              style: const TextStyle(
                color: Colors.black,
                fontSize: 18.0,
                fontWeight: FontWeight.w600,
            ...
            MyTextView(
                "Total Price: ${widget.finalAmount.toStringAsFixed(2)}৳",
                16,
                FontWeight.bold,
                Colors.black,
                TextAlign.start),
